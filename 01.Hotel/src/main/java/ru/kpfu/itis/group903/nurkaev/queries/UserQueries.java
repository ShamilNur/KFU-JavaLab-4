...
public class UserQueries {
    ...
    // language=SQL
    public static final String SQL_INSERT = "INSERT INTO user_hotel (first_name, last_name, email, hash_password) " +
            "VALUES (:first_name, :last_name, :email, :hash_password);";

    // language=SQL
    public static final String SQL_UPDATE_BY_ID = "UPDATE user_hotel " +
            "SET first_name = :first_name, last_name = :last_name, email = :email, rooms_id = :rooms_id " +
            "WHERE id = :id;";

    // language=SQL
    public static final String SQL_UPDATE_BY_EMAIL = "UPDATE user_hotel " +
            "SET first_name = :first_name, last_name = :last_name WHERE email = :email;";
